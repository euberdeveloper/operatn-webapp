...
const documentDefinition = () => {
    ...
    content: [
      ...
      table: {
        widths: ['*'],
        body: [
          ['VERBALE DI MODIFICA ASSEGNAZIONE DEL POSTO ALLOGGIO\nANNO ACCADEMICO VAL'],
        ],
      },
      alignment: "center",
      margin: [0, 5, 0, 5]
    },
    `Il VAL_GIORNO presso gli uffici dell'Opera Universitaria di Trento, alla presenza dell’incaricato dell’Ente, si è presentato/a il/la signor/a`,
      ` `,
      {
        text: `COGNOME NOME`,
        bold: true,
      ...
      ` `,
      `per procedere agli adempimenti inerenti alla modifica della data di assegnazione del posto alloggio per l'anno accademico  2019/2020
  
  
  L ’assegnazione del posto alloggio sito in:
  ...
  stanza Doppia numero FB3C52`,
      ...
      ` `,
      {
        text: 'avrà scadenza  in data  VAL',
        bold: true,
        alignment: "center",
        fontSize: 10,
      },
