<template>
  <v-card flat>
    <v-card-text>
      ...
      <p>
        Nam ipsum risus, rutrum vitae, vestibulum eu, molestie vel, lacus. Aenean tellus metus, bibendum sed, posuere ac, mattis non, nunc. Aliquam lobortis. Aliquam
...
@Component
export default class TabelloneEsporta extends Vue {}
</script>
